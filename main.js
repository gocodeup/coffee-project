...
function renderCoffee(coffee) {
    ...
    html += `<p class="d-flex justify-content-end m-0 pt-4 pe-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cup-hot" viewBox="0 0 16 16">;
