...
// function enterDiv(elem) {
//     elem.document.getElementById('cp-test-background').style.backgroundColor = 'red';
// }
...
var mouseEvent  = function () {
    hoverOverCoffee.addEventListener('mouseenter', function (e){
        e.target.style.color = "purple";
    });
}

var mouseEventLeave = function () {
